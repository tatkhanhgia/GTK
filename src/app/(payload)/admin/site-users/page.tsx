...
import { CustomHeader } from '@/admin/components/layout/custom-header'
...
export default async function SiteUsersPage({ searchParams }: Props) {
  ...
  return (
    <>
      <CustomHeader />
      <main className="min-h-[calc(100dvh-5rem)] bg-[var(--admin-bg-primary)] px-4 py-5 text-[var(--admin-text-primary)] transition-[margin-left] duration-300 md:ml-[var(--admin-sidebar-width)] md:px-6 lg:px-7">
